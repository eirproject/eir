    ...
    pub fn to_diagnostic(&self) -> Diagnostic {
        ...
        match *self {
            LexicalError::InvalidFloat { .. } => Diagnostic::error()
                ...
                .with_labels(vec![Label::primary(span.source_id(), span).with_message(msg)]),
            ...
            _ => Diagnostic::error().with_message(msg).with_labels(vec![Label::primary(span.source_id(), span)]),
        }
    }
}
